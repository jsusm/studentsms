...
const Schema: z.ZodType<Prisma.SessionUncheckedUpdateManyWithoutKlassNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => SessionUpsertWithWhereUniqueWithoutKlassInputObjectSchema,
          ),
          z
            .lazy(
              () => SessionUpsertWithWhereUniqueWithoutKlassInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => SessionUpdateWithWhereUniqueWithoutKlassInputObjectSchema,
          ),
          z
            .lazy(
              () => SessionUpdateWithWhereUniqueWithoutKlassInputObjectSchema,
...
export const SessionUncheckedUpdateManyWithoutKlassNestedInputObjectSchema =
  Schema;
