...
const Schema: z.ZodType<Prisma.SessionUncheckedCreateNestedManyWithoutKlassInput> =
  z
    .object({
      create: z
        .union([
...
export const SessionUncheckedCreateNestedManyWithoutKlassInputObjectSchema =
  Schema;
